...
public class OpGroupLogicalXorKHR implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_LOGICAL_XOR_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupLogicalXorKHR)) {
			return false;
		}
		OpGroupLogicalXorKHR other = (OpGroupLogicalXorKHR) o;
