...
public class OpSubgroup2DBlockStoreINTEL implements GroupInstruction {
	public Instruction elementSize;
	public Instruction blockWidth;
	public Instruction blockHeight;
	public Instruction blockCount;
	public Instruction srcPointer;
	public Instruction dstBasePointer;
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.srcPointer = instructions[data[offset + 4]];
		this.dstBasePointer = instructions[data[offset + 5]];
		this.memoryWidth = instructions[data[offset + 6]];
		this.memoryHeight = instructions[data[offset + 7]];
		this.memoryPitch = instructions[data[offset + 8]];
		this.coordinate = instructions[data[offset + 9]];
	}
	...
	public void write(InstructionWriter writer) {
		...
		writer.write(this.srcPointer);
		writer.write(this.dstBasePointer);
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP2D_BLOCK_STORE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroup2DBlockStoreINTEL)) {
			return false;
		}
		...
		if (!this.srcPointer.equals(other.srcPointer)) {
			return false;
		}
		if (!this.dstBasePointer.equals(other.dstBasePointer)) {
			return false;
		}
	...
	public int hashCode() {
		...
		result += 31 * result + this.srcPointer.hashCode();
		result += 31 * result + this.dstBasePointer.hashCode();
