...
public class OpGroupLogicalOrKHR implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_LOGICAL_OR_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupLogicalOrKHR)) {
			return false;
		}
