...
public class OpGroupBitwiseOrKHR implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_BITWISE_OR_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupBitwiseOrKHR)) {
			return false;
		}
		OpGroupBitwiseOrKHR other = (OpGroupBitwiseOrKHR) o;
