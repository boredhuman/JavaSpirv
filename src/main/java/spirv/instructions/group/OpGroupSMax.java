...
public class OpGroupSMax implements GroupInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupSMax)) {
			return false;
		}
		OpGroupSMax other = (OpGroupSMax) o;
