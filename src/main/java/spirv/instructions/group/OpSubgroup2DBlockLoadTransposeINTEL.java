...
public class OpSubgroup2DBlockLoadTransposeINTEL implements GroupInstruction {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP2D_BLOCK_LOAD_TRANSPOSE_INTEL;
	}

	@Override
	public String[] capabilities() {
		 return new String[] { "Subgroup2DBlockTransposeINTEL" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroup2DBlockLoadTransposeINTEL)) {
			return false;
		}
		OpSubgroup2DBlockLoadTransposeINTEL other = (OpSubgroup2DBlockLoadTransposeINTEL) o;
