...
public class OpSubgroup2DBlockLoadINTEL implements GroupInstruction {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP2D_BLOCK_LOAD_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroup2DBlockLoadINTEL)) {
			return false;
		}
		OpSubgroup2DBlockLoadINTEL other = (OpSubgroup2DBlockLoadINTEL) o;
