...
public class OpGroupAll implements GroupInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupAll)) {
			return false;
		}
		OpGroupAll other = (OpGroupAll) o;
