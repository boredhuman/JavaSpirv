...
public class OpGroupBitwiseAndKHR implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_BITWISE_AND_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupBitwiseAndKHR)) {
			return false;
		}
		OpGroupBitwiseAndKHR other = (OpGroupBitwiseAndKHR) o;
