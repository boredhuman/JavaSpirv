...
public class OpGroupFMax implements GroupInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupFMax)) {
			return false;
		}
		OpGroupFMax other = (OpGroupFMax) o;
