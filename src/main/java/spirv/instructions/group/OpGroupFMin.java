...
public class OpGroupFMin implements GroupInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupFMin)) {
			return false;
		}
		OpGroupFMin other = (OpGroupFMin) o;
