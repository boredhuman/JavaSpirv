...
public class OpSubgroup2DBlockLoadTransformINTEL implements GroupInstruction {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.dstPointer = instructions[data[offset + 9]];
	}
	...
	public void write(InstructionWriter writer) {
		...
		writer.write(this.dstPointer);
	}

	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP2D_BLOCK_LOAD_TRANSFORM_INTEL;
	}

	@Override
	public String[] capabilities() {
		 return new String[] { "Subgroup2DBlockTransformINTEL" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroup2DBlockLoadTransformINTEL)) {
			return false;
		}
		OpSubgroup2DBlockLoadTransformINTEL other = (OpSubgroup2DBlockLoadTransformINTEL) o;
		...
		return this.dstPointer.equals(other.dstPointer);
	}
	...
	public int hashCode() {
		...
		return 31 * result + this.dstPointer.hashCode();
	}
}