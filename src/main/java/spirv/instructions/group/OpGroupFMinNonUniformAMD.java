...
public class OpGroupFMinNonUniformAMD implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_F_MIN_NON_UNIFORM_AMD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupFMinNonUniformAMD)) {
			return false;
		}
		OpGroupFMinNonUniformAMD other = (OpGroupFMinNonUniformAMD) o;
