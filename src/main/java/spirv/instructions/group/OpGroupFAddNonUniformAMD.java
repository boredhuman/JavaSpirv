...
public class OpGroupFAddNonUniformAMD implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_F_ADD_NON_UNIFORM_AMD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupFAddNonUniformAMD)) {
			return false;
		}
		OpGroupFAddNonUniformAMD other = (OpGroupFAddNonUniformAMD) o;
