...
public class OpGroupUMin implements GroupInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupUMin)) {
			return false;
		}
		OpGroupUMin other = (OpGroupUMin) o;
