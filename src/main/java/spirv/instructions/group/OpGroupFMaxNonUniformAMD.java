...
public class OpGroupFMaxNonUniformAMD implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_F_MAX_NON_UNIFORM_AMD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupFMaxNonUniformAMD)) {
			return false;
		}
		OpGroupFMaxNonUniformAMD other = (OpGroupFMaxNonUniformAMD) o;
