...
public class OpGroupLogicalAndKHR implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_LOGICAL_AND_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupLogicalAndKHR)) {
			return false;
		}
		OpGroupLogicalAndKHR other = (OpGroupLogicalAndKHR) o;
