...
public class OpGroupIAddNonUniformAMD implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_I_ADD_NON_UNIFORM_AMD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupIAddNonUniformAMD)) {
			return false;
		}
		OpGroupIAddNonUniformAMD other = (OpGroupIAddNonUniformAMD) o;
