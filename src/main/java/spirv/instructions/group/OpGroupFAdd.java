...
public class OpGroupFAdd implements GroupInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupFAdd)) {
			return false;
		}
		OpGroupFAdd other = (OpGroupFAdd) o;
