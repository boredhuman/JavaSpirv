...
public class OpGroupIMulKHR implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_I_MUL_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupIMulKHR)) {
			return false;
		}
		OpGroupIMulKHR other = (OpGroupIMulKHR) o;
