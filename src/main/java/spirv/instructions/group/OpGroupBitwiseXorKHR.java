...
public class OpGroupBitwiseXorKHR implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_BITWISE_XOR_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupBitwiseXorKHR)) {
			return false;
		}
