...
public class OpGroupUMinNonUniformAMD implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_U_MIN_NON_UNIFORM_AMD;
	}
	...
	public String[] extensions() {
		 return new String[] { "SPV_AMD_shader_ballot" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupUMinNonUniformAMD)) {
			return false;
		}
		OpGroupUMinNonUniformAMD other = (OpGroupUMinNonUniformAMD) o;
