...
public class OpGroupUMaxNonUniformAMD implements GroupInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_U_MAX_NON_UNIFORM_AMD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupUMaxNonUniformAMD)) {
			return false;
		}
		OpGroupUMaxNonUniformAMD other = (OpGroupUMaxNonUniformAMD) o;
