...
public class OpINotEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpINotEqual)) {
			return false;
		}
		OpINotEqual other = (OpINotEqual) o;
