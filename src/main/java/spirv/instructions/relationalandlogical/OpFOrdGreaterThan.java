...
public class OpFOrdGreaterThan implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_ORD_GREATER_THAN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFOrdGreaterThan)) {
			return false;
		}
		OpFOrdGreaterThan other = (OpFOrdGreaterThan) o;
