...
public class OpUGreaterThanEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_U_GREATER_THAN_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUGreaterThanEqual)) {
			return false;
		}
		OpUGreaterThanEqual other = (OpUGreaterThanEqual) o;
