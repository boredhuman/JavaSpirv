...
public class OpSLessThanEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_S_LESS_THAN_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSLessThanEqual)) {
			return false;
		}
		OpSLessThanEqual other = (OpSLessThanEqual) o;
