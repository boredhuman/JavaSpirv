...
public class OpFOrdLessThan implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_ORD_LESS_THAN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFOrdLessThan)) {
			return false;
		}
		OpFOrdLessThan other = (OpFOrdLessThan) o;
