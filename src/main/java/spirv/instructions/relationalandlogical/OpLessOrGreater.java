...
public class OpLessOrGreater implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_LESS_OR_GREATER;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpLessOrGreater)) {
			return false;
		}
