...
public class OpFOrdLessThanEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_ORD_LESS_THAN_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFOrdLessThanEqual)) {
			return false;
		}
