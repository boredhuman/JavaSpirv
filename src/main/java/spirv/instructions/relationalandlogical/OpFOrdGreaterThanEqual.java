...
public class OpFOrdGreaterThanEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_ORD_GREATER_THAN_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFOrdGreaterThanEqual)) {
			return false;
		}
