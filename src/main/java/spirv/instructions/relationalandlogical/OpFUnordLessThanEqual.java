...
public class OpFUnordLessThanEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_UNORD_LESS_THAN_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFUnordLessThanEqual)) {
			return false;
		}
		OpFUnordLessThanEqual other = (OpFUnordLessThanEqual) o;
