...
public class OpFUnordNotEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_UNORD_NOT_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFUnordNotEqual)) {
			return false;
		}
		OpFUnordNotEqual other = (OpFUnordNotEqual) o;
