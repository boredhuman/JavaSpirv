...
public class OpULessThanEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_U_LESS_THAN_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpULessThanEqual)) {
			return false;
		}
		OpULessThanEqual other = (OpULessThanEqual) o;
