...
public class OpSGreaterThanEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_S_GREATER_THAN_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSGreaterThanEqual)) {
			return false;
		}
		OpSGreaterThanEqual other = (OpSGreaterThanEqual) o;
