...
public class OpUGreaterThan implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_U_GREATER_THAN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUGreaterThan)) {
			return false;
		}
