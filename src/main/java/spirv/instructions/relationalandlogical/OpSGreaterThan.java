...
public class OpSGreaterThan implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_S_GREATER_THAN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSGreaterThan)) {
			return false;
		}
		OpSGreaterThan other = (OpSGreaterThan) o;
