...
public class OpFOrdNotEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_ORD_NOT_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFOrdNotEqual)) {
			return false;
		}
		OpFOrdNotEqual other = (OpFOrdNotEqual) o;
