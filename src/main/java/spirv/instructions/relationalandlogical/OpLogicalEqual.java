...
public class OpLogicalEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_LOGICAL_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpLogicalEqual)) {
			return false;
		}
		OpLogicalEqual other = (OpLogicalEqual) o;
