...
public class OpLogicalNotEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_LOGICAL_NOT_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpLogicalNotEqual)) {
			return false;
		}
		OpLogicalNotEqual other = (OpLogicalNotEqual) o;
