...
public class OpFUnordGreaterThan implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_UNORD_GREATER_THAN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFUnordGreaterThan)) {
			return false;
		}
