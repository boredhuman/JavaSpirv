...
public class OpSLessThan implements RelationalandLogicalInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSLessThan)) {
			return false;
		}
		OpSLessThan other = (OpSLessThan) o;
