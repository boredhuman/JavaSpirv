...
public class OpFUnordGreaterThanEqual implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_UNORD_GREATER_THAN_EQUAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFUnordGreaterThanEqual)) {
			return false;
		}
		OpFUnordGreaterThanEqual other = (OpFUnordGreaterThanEqual) o;
