...
public class OpFUnordLessThan implements RelationalandLogicalInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_F_UNORD_LESS_THAN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFUnordLessThan)) {
			return false;
		}
		OpFUnordLessThan other = (OpFUnordLessThan) o;
