...
public class OpUMulExtended implements ArithmeticInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_U_MUL_EXTENDED;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUMulExtended)) {
			return false;
		}
		OpUMulExtended other = (OpUMulExtended) o;
