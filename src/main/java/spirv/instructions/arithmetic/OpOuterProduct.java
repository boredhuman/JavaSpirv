...
public class OpOuterProduct implements ArithmeticInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_OUTER_PRODUCT;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpOuterProduct)) {
			return false;
		}
		...
		return this.vector2.equals(other.vector2);
	}
	...
	public int hashCode() {
		...
		return 31 * result + this.vector2.hashCode();
	}
}