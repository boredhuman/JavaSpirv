...
public class OpSMulExtended implements ArithmeticInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_S_MUL_EXTENDED;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSMulExtended)) {
			return false;
		}
		OpSMulExtended other = (OpSMulExtended) o;
