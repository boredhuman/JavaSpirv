...
public class OpSUDotAccSat implements ArithmeticInstruction, ResultType, Result {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.accumulator = instructions[data[offset + 4]];
		if (length - 5 <= 0) {
			return;
		}
		this.packedVectorFormat = PackedVectorFormat.get(data[offset + 5]);
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SU_DOT_ACC_SAT;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSUDotAccSat)) {
			return false;
		}
		OpSUDotAccSat other = (OpSUDotAccSat) o;
