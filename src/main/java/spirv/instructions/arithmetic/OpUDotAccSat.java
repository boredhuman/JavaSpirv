...
public class OpUDotAccSat implements ArithmeticInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_U_DOT_ACC_SAT;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUDotAccSat)) {
			return false;
		}
		OpUDotAccSat other = (OpUDotAccSat) o;
