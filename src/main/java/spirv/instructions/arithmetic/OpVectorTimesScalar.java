...
public class OpVectorTimesScalar implements ArithmeticInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_VECTOR_TIMES_SCALAR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpVectorTimesScalar)) {
			return false;
		}
		OpVectorTimesScalar other = (OpVectorTimesScalar) o;
