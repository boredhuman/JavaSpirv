...
public class OpImageSampleProjDrefExplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SAMPLE_PROJ_DREF_EXPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSampleProjDrefExplicitLod)) {
			return false;
		}
		OpImageSampleProjDrefExplicitLod other = (OpImageSampleProjDrefExplicitLod) o;
