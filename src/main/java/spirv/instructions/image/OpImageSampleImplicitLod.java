...
public class OpImageSampleImplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SAMPLE_IMPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSampleImplicitLod)) {
			return false;
		}
		OpImageSampleImplicitLod other = (OpImageSampleImplicitLod) o;
