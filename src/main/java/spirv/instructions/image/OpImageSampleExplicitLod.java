...
public class OpImageSampleExplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SAMPLE_EXPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSampleExplicitLod)) {
			return false;
		}
		OpImageSampleExplicitLod other = (OpImageSampleExplicitLod) o;
