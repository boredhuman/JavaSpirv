...
public class OpImageSampleDrefImplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SAMPLE_DREF_IMPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSampleDrefImplicitLod)) {
			return false;
		}
		OpImageSampleDrefImplicitLod other = (OpImageSampleDrefImplicitLod) o;
