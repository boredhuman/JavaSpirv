...
public class OpImageSampleProjDrefImplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SAMPLE_PROJ_DREF_IMPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSampleProjDrefImplicitLod)) {
			return false;
		}
