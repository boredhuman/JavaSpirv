...
public class OpImageSampleWeightedQCOM implements ImageInstruction, ResultType, Result {
	public Instruction idResultType;
	public int idResult;
	public Instruction texture;
	public Instruction coordinates;
	public Instruction weights;
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.weights = instructions[data[offset + 4]];
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SAMPLE_WEIGHTED_QCOM;
	}
	...
	public String[] capabilities() {
		 return new String[] { "TextureSampleWeightedQCOM" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSampleWeightedQCOM)) {
			return false;
		}
	...
	public int hashCode() {
		...
		return 31 * result + this.weights.hashCode();
	}
}