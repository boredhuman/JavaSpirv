...
public class OpImageBlockMatchSSDQCOM implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_BLOCK_MATCH_SSDQCOM;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageBlockMatchSSDQCOM)) {
			return false;
		}
		OpImageBlockMatchSSDQCOM other = (OpImageBlockMatchSSDQCOM) o;
