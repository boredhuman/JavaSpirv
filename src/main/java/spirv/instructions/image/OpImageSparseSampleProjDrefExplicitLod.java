...
public class OpImageSparseSampleProjDrefExplicitLod implements ImageInstruction, ResultType, Result {
	public Instruction idResultType;
	public int idResult;
	public Instruction sampledImage;
	public Instruction coordinate;
	public Instruction dref;
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.dref = instructions[data[offset + 4]];
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_SAMPLE_PROJ_DREF_EXPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseSampleProjDrefExplicitLod)) {
			return false;
		}
		OpImageSparseSampleProjDrefExplicitLod other = (OpImageSparseSampleProjDrefExplicitLod) o;
		...
		if (!this.dref.equals(other.dref)) {
			return false;
		}
		if (this.imageOperands != other.imageOperands) {
			return false;
		}
	...
	public int hashCode() {
		...
		result += 31 * result + this.dref.hashCode();
		result += 31 * result + this.imageOperands;
