...
public class OpImageSampleProjExplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SAMPLE_PROJ_EXPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSampleProjExplicitLod)) {
			return false;
		}
		OpImageSampleProjExplicitLod other = (OpImageSampleProjExplicitLod) o;
