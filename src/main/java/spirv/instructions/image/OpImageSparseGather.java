...
public class OpImageSparseGather implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_GATHER;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseGather)) {
			return false;
		}
		OpImageSparseGather other = (OpImageSparseGather) o;
