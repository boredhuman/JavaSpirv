...
public class OpImageSparseSampleProjImplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_SAMPLE_PROJ_IMPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseSampleProjImplicitLod)) {
			return false;
		}
		OpImageSparseSampleProjImplicitLod other = (OpImageSparseSampleProjImplicitLod) o;
