...
public class OpImageSparseSampleProjDrefImplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_SAMPLE_PROJ_DREF_IMPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseSampleProjDrefImplicitLod)) {
			return false;
		}
		OpImageSparseSampleProjDrefImplicitLod other = (OpImageSparseSampleProjDrefImplicitLod) o;
