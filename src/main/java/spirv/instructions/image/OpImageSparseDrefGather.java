...
public class OpImageSparseDrefGather implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_DREF_GATHER;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseDrefGather)) {
			return false;
		}
