...
public class OpImageQueryLevels implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_QUERY_LEVELS;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageQueryLevels)) {
			return false;
		}
		OpImageQueryLevels other = (OpImageQueryLevels) o;
