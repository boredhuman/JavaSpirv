...
public class OpImageSparseSampleImplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_SAMPLE_IMPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseSampleImplicitLod)) {
			return false;
		}
