...
public class OpConvertHandleToSamplerINTEL implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONVERT_HANDLE_TO_SAMPLER_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpConvertHandleToSamplerINTEL)) {
			return false;
		}
