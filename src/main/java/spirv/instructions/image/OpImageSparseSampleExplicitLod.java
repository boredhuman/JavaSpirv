...
public class OpImageSparseSampleExplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_SAMPLE_EXPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseSampleExplicitLod)) {
			return false;
		}
		OpImageSparseSampleExplicitLod other = (OpImageSparseSampleExplicitLod) o;
