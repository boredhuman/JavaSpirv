...
public class OpStencilAttachmentReadEXT implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_STENCIL_ATTACHMENT_READ_EXT;
	}
	...
	public String[] capabilities() {
		 return new String[] { "TileImageStencilReadAccessEXT" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpStencilAttachmentReadEXT)) {
			return false;
		}
