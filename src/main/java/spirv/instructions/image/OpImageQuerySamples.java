...
public class OpImageQuerySamples implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_QUERY_SAMPLES;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageQuerySamples)) {
			return false;
		}
