...
public class OpImageSparseSampleDrefImplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_SAMPLE_DREF_IMPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseSampleDrefImplicitLod)) {
			return false;
		}
		OpImageSparseSampleDrefImplicitLod other = (OpImageSparseSampleDrefImplicitLod) o;
