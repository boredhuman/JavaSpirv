...
public class OpImageBlockMatchGatherSSDQCOM implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_BLOCK_MATCH_GATHER_SSDQCOM;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageBlockMatchGatherSSDQCOM)) {
			return false;
		}
		OpImageBlockMatchGatherSSDQCOM other = (OpImageBlockMatchGatherSSDQCOM) o;
