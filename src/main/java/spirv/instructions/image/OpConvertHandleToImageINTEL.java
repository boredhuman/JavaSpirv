...
public class OpConvertHandleToImageINTEL implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONVERT_HANDLE_TO_IMAGE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpConvertHandleToImageINTEL)) {
			return false;
		}
