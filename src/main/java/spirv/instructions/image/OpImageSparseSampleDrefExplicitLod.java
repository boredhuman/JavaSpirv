...
public class OpImageSparseSampleDrefExplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_SAMPLE_DREF_EXPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseSampleDrefExplicitLod)) {
			return false;
		}
		OpImageSparseSampleDrefExplicitLod other = (OpImageSparseSampleDrefExplicitLod) o;
