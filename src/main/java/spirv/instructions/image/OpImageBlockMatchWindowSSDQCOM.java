...
public class OpImageBlockMatchWindowSSDQCOM implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_BLOCK_MATCH_WINDOW_SSDQCOM;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageBlockMatchWindowSSDQCOM)) {
			return false;
		}
		OpImageBlockMatchWindowSSDQCOM other = (OpImageBlockMatchWindowSSDQCOM) o;
