...
public class OpImageSampleProjImplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SAMPLE_PROJ_IMPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSampleProjImplicitLod)) {
			return false;
		}
		OpImageSampleProjImplicitLod other = (OpImageSampleProjImplicitLod) o;
