...
public class OpImageSparseSampleProjExplicitLod implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_SPARSE_SAMPLE_PROJ_EXPLICIT_LOD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageSparseSampleProjExplicitLod)) {
			return false;
		}
		OpImageSparseSampleProjExplicitLod other = (OpImageSparseSampleProjExplicitLod) o;
