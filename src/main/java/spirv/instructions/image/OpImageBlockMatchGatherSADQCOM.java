...
public class OpImageBlockMatchGatherSADQCOM implements ImageInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IMAGE_BLOCK_MATCH_GATHER_SADQCOM;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpImageBlockMatchGatherSADQCOM)) {
			return false;
		}
