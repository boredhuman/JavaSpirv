...
public class OpExtInstWithForwardRefsKHR implements ExtensionInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_EXT_INST_WITH_FORWARD_REFS_KHR;
	}
	...
	public String[] extensions() {
		 return new String[] { "SPV_KHR_relaxed_extended_instruction" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpExtInstWithForwardRefsKHR)) {
			return false;
		}
		OpExtInstWithForwardRefsKHR other = (OpExtInstWithForwardRefsKHR) o;
