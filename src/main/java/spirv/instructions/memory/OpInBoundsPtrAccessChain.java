...
public class OpInBoundsPtrAccessChain implements MemoryInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_IN_BOUNDS_PTR_ACCESS_CHAIN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpInBoundsPtrAccessChain)) {
			return false;
		}
		OpInBoundsPtrAccessChain other = (OpInBoundsPtrAccessChain) o;
