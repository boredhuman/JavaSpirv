...
public class OpUntypedPtrAccessChainKHR implements MemoryInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_UNTYPED_PTR_ACCESS_CHAIN_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUntypedPtrAccessChainKHR)) {
			return false;
		}
		OpUntypedPtrAccessChainKHR other = (OpUntypedPtrAccessChainKHR) o;
