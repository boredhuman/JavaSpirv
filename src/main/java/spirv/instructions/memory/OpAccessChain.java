...
public class OpAccessChain implements MemoryInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ACCESS_CHAIN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpAccessChain)) {
			return false;
		}
		OpAccessChain other = (OpAccessChain) o;
