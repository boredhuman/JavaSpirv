...
public class OpPtrDiff implements MemoryInstruction, ResultType, Result {
	...
	public String[] capabilities() {
		 return new String[] { "Addresses", "VariablePointers", "VariablePointersStorageBuffer" };
	}
