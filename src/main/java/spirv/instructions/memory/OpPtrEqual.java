...
public class OpPtrEqual implements MemoryInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpPtrEqual)) {
			return false;
		}
		OpPtrEqual other = (OpPtrEqual) o;
