...
public class OpUntypedInBoundsAccessChainKHR implements MemoryInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_UNTYPED_IN_BOUNDS_ACCESS_CHAIN_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUntypedInBoundsAccessChainKHR)) {
			return false;
		}
		OpUntypedInBoundsAccessChainKHR other = (OpUntypedInBoundsAccessChainKHR) o;
