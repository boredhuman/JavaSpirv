...
public class OpCooperativeMatrixLoadTensorNV implements MemoryInstruction, ResultType, Result {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.object = instructions[data[offset + 3]];
		this.tensorLayout = instructions[data[offset + 4]];
		this.memoryOperand = data[offset + 5];
		this.memoryOperandArg = MemoryAccess.loadArg(this.memoryOperand, data, offset + 6, instructions);
		int dynamicOffset = MemoryAccess.getArgumentCount(this.memoryOperand) + 6;
	...
	@Override
	public int opcode() {
		return OpCodes.OP_COOPERATIVE_MATRIX_LOAD_TENSOR_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpCooperativeMatrixLoadTensorNV)) {
			return false;
		}
