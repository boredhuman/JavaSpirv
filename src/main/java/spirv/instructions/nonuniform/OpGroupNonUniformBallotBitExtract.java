...
public class OpGroupNonUniformBallotBitExtract implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_BALLOT_BIT_EXTRACT;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformBallotBitExtract)) {
			return false;
		}
		OpGroupNonUniformBallotBitExtract other = (OpGroupNonUniformBallotBitExtract) o;
