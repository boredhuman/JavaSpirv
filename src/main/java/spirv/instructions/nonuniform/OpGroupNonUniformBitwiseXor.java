...
public class OpGroupNonUniformBitwiseXor implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_BITWISE_XOR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformBitwiseXor)) {
			return false;
		}
