...
public class OpGroupNonUniformUMax implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_U_MAX;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformUMax)) {
			return false;
		}
		OpGroupNonUniformUMax other = (OpGroupNonUniformUMax) o;
