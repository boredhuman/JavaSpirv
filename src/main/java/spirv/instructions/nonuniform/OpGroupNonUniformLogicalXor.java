...
public class OpGroupNonUniformLogicalXor implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_LOGICAL_XOR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformLogicalXor)) {
			return false;
		}
