...
public class OpGroupNonUniformUMin implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_U_MIN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformUMin)) {
			return false;
		}
		OpGroupNonUniformUMin other = (OpGroupNonUniformUMin) o;
