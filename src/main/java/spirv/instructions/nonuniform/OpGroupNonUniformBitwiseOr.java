...
public class OpGroupNonUniformBitwiseOr implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_BITWISE_OR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformBitwiseOr)) {
			return false;
		}
