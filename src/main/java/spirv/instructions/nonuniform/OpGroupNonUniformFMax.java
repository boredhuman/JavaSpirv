...
public class OpGroupNonUniformFMax implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_F_MAX;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformFMax)) {
			return false;
		}
		OpGroupNonUniformFMax other = (OpGroupNonUniformFMax) o;
