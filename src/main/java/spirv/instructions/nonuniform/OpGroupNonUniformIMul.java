...
public class OpGroupNonUniformIMul implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_I_MUL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformIMul)) {
			return false;
		}
