...
public class OpGroupNonUniformBitwiseAnd implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_BITWISE_AND;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformBitwiseAnd)) {
			return false;
		}
		OpGroupNonUniformBitwiseAnd other = (OpGroupNonUniformBitwiseAnd) o;
