...
public class OpGroupNonUniformAny implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_ANY;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformAny)) {
			return false;
		}
