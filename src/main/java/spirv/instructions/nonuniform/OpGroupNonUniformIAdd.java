...
public class OpGroupNonUniformIAdd implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_I_ADD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformIAdd)) {
			return false;
		}
		OpGroupNonUniformIAdd other = (OpGroupNonUniformIAdd) o;
