...
public class OpGroupNonUniformShuffleDown implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_SHUFFLE_DOWN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformShuffleDown)) {
			return false;
		}
		OpGroupNonUniformShuffleDown other = (OpGroupNonUniformShuffleDown) o;
