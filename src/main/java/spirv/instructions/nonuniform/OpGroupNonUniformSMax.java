...
public class OpGroupNonUniformSMax implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_S_MAX;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformSMax)) {
			return false;
		}
