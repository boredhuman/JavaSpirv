...
public class OpGroupNonUniformFMin implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_F_MIN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformFMin)) {
			return false;
		}
