...
public class OpGroupNonUniformBallotFindLSB implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_BALLOT_FIND_LSB;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformBallotFindLSB)) {
			return false;
		}
		OpGroupNonUniformBallotFindLSB other = (OpGroupNonUniformBallotFindLSB) o;
