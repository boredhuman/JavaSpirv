...
public class OpGroupNonUniformBallotBitCount implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_BALLOT_BIT_COUNT;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformBallotBitCount)) {
			return false;
		}
