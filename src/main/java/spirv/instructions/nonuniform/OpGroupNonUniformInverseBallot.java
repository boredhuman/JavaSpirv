...
public class OpGroupNonUniformInverseBallot implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_INVERSE_BALLOT;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformInverseBallot)) {
			return false;
		}
		OpGroupNonUniformInverseBallot other = (OpGroupNonUniformInverseBallot) o;
