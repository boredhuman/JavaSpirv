...
public class OpGroupNonUniformQuadBroadcast implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_QUAD_BROADCAST;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformQuadBroadcast)) {
			return false;
		}
