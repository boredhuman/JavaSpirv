...
public class OpGroupNonUniformAll implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_ALL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformAll)) {
			return false;
		}
		OpGroupNonUniformAll other = (OpGroupNonUniformAll) o;
