...
public class OpGroupNonUniformQuadSwap implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_QUAD_SWAP;
	}
	...
	public String[] capabilities() {
		 return new String[] { "GroupNonUniformQuad" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformQuadSwap)) {
			return false;
		}
		OpGroupNonUniformQuadSwap other = (OpGroupNonUniformQuadSwap) o;
