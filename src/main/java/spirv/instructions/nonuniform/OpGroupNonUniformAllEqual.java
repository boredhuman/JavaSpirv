...
public class OpGroupNonUniformAllEqual implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_ALL_EQUAL;
	}
	...
	public String[] capabilities() {
		 return new String[] { "GroupNonUniformVote" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformAllEqual)) {
			return false;
		}
		OpGroupNonUniformAllEqual other = (OpGroupNonUniformAllEqual) o;
