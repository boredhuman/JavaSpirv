...
public class OpGroupNonUniformLogicalAnd implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_LOGICAL_AND;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformLogicalAnd)) {
			return false;
		}
		OpGroupNonUniformLogicalAnd other = (OpGroupNonUniformLogicalAnd) o;
