...
public class OpGroupNonUniformBroadcastFirst implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_BROADCAST_FIRST;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformBroadcastFirst)) {
			return false;
		}
