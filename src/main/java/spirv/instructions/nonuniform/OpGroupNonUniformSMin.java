...
public class OpGroupNonUniformSMin implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_S_MIN;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformSMin)) {
			return false;
		}
		OpGroupNonUniformSMin other = (OpGroupNonUniformSMin) o;
