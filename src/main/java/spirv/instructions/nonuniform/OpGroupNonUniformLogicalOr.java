...
public class OpGroupNonUniformLogicalOr implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_LOGICAL_OR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformLogicalOr)) {
			return false;
		}
		OpGroupNonUniformLogicalOr other = (OpGroupNonUniformLogicalOr) o;
