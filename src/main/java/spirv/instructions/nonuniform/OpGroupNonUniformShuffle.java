...
public class OpGroupNonUniformShuffle implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_SHUFFLE;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformShuffle)) {
			return false;
		}
