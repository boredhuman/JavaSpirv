...
public class OpGroupNonUniformFAdd implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_F_ADD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformFAdd)) {
			return false;
		}
