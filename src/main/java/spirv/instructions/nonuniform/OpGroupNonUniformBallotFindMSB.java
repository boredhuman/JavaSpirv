...
public class OpGroupNonUniformBallotFindMSB implements NonUniformInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_NON_UNIFORM_BALLOT_FIND_MSB;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupNonUniformBallotFindMSB)) {
			return false;
		}
