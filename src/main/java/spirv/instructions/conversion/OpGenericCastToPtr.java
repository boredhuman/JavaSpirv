...
public class OpGenericCastToPtr implements ConversionInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GENERIC_CAST_TO_PTR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGenericCastToPtr)) {
			return false;
		}
		OpGenericCastToPtr other = (OpGenericCastToPtr) o;
