...
public class OpBitCastArrayQCOM implements ConversionInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_BIT_CAST_ARRAY_QCOM;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpBitCastArrayQCOM)) {
			return false;
		}
