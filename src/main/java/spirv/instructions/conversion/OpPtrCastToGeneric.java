...
public class OpPtrCastToGeneric implements ConversionInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_PTR_CAST_TO_GENERIC;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpPtrCastToGeneric)) {
			return false;
		}
