...
public class OpBitcast implements ConversionInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpBitcast)) {
			return false;
		}
		OpBitcast other = (OpBitcast) o;
