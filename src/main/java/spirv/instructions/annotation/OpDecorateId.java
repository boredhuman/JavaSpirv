...
public class OpDecorateId implements AnnotationInstruction {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_DECORATE_ID;
	}

	@Override
	public String[] extensions() {
		 return new String[] { "SPV_GOOGLE_hlsl_functionality1" };
	}
