...
public class OpShiftLeftLogical implements BitInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SHIFT_LEFT_LOGICAL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpShiftLeftLogical)) {
			return false;
		}
		OpShiftLeftLogical other = (OpShiftLeftLogical) o;
