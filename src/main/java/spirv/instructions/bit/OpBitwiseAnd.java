...
public class OpBitwiseAnd implements BitInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpBitwiseAnd)) {
			return false;
		}
		OpBitwiseAnd other = (OpBitwiseAnd) o;
