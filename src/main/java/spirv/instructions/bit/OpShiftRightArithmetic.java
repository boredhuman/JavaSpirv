...
public class OpShiftRightArithmetic implements BitInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SHIFT_RIGHT_ARITHMETIC;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpShiftRightArithmetic)) {
			return false;
		}
