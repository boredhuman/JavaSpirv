...
public class OpBitFieldInsert implements BitInstruction, ResultType, Result {
	public Instruction idResultType;
	public int idResult;
	public Instruction base;
	public Instruction insert;
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.insert = instructions[data[offset + 3]];
		this.offset = instructions[data[offset + 4]];
		this.count = instructions[data[offset + 5]];
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_BIT_FIELD_INSERT;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpBitFieldInsert)) {
			return false;
		}
		...
		if (!this.insert.equals(other.insert)) {
			return false;
		}
	...
	public int hashCode() {
		...
		result += 31 * result + this.insert.hashCode();
