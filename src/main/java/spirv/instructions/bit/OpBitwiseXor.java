...
public class OpBitwiseXor implements BitInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpBitwiseXor)) {
			return false;
		}
		OpBitwiseXor other = (OpBitwiseXor) o;
