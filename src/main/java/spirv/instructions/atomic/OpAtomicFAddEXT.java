...
public class OpAtomicFAddEXT implements AtomicInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ATOMIC_F_ADD_EXT;
	}
	...
	public String[] capabilities() {
		 return new String[] { "AtomicFloat16AddEXT", "AtomicFloat32AddEXT", "AtomicFloat64AddEXT", "AtomicFloat16VectorNV" };
	}

	@Override
	public String[] extensions() {
		 return new String[] { "SPV_EXT_shader_atomic_float_add" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpAtomicFAddEXT)) {
			return false;
		}
