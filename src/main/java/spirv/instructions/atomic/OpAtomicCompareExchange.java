...
public class OpAtomicCompareExchange implements AtomicInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ATOMIC_COMPARE_EXCHANGE;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpAtomicCompareExchange)) {
			return false;
		}
