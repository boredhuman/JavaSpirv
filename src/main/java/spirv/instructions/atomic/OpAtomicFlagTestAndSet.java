...
public class OpAtomicFlagTestAndSet implements AtomicInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ATOMIC_FLAG_TEST_AND_SET;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpAtomicFlagTestAndSet)) {
			return false;
		}
