...
public class OpAtomicFMinEXT implements AtomicInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ATOMIC_F_MIN_EXT;
	}
	...
	public String[] capabilities() {
		 return new String[] { "AtomicFloat16MinMaxEXT", "AtomicFloat32MinMaxEXT", "AtomicFloat64MinMaxEXT", "AtomicFloat16VectorNV" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpAtomicFMinEXT)) {
			return false;
		}
