...
public class OpAtomicIIncrement implements AtomicInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ATOMIC_I_INCREMENT;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpAtomicIIncrement)) {
			return false;
		}
		OpAtomicIIncrement other = (OpAtomicIIncrement) o;
