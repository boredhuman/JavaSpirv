...
public class OpAtomicOr implements AtomicInstruction, ResultType, Result {
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpAtomicOr)) {
			return false;
		}
		OpAtomicOr other = (OpAtomicOr) o;
