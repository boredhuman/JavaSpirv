...
public class OpAtomicSMax implements AtomicInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ATOMIC_S_MAX;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpAtomicSMax)) {
			return false;
		}
		OpAtomicSMax other = (OpAtomicSMax) o;
