...
public class OpReservedWritePipe implements PipeInstruction, ResultType, Result {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.reserveId = instructions[data[offset + 3]];
		this.index = instructions[data[offset + 4]];
		this.pointer = instructions[data[offset + 5]];
		this.packetSize = instructions[data[offset + 6]];
		this.packetAlignment = instructions[data[offset + 7]];
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RESERVED_WRITE_PIPE;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpReservedWritePipe)) {
			return false;
		}
