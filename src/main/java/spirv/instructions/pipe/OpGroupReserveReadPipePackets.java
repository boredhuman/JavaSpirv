...
public class OpGroupReserveReadPipePackets implements PipeInstruction, ResultType, Result {
	public Instruction idResultType;
	public int idResult;
	public Instruction execution;
	public Instruction pipe;
	public Instruction numPackets;
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.pipe = instructions[data[offset + 3]];
		this.numPackets = instructions[data[offset + 4]];
		this.packetSize = instructions[data[offset + 5]];
		this.packetAlignment = instructions[data[offset + 6]];
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_RESERVE_READ_PIPE_PACKETS;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupReserveReadPipePackets)) {
			return false;
		}
		OpGroupReserveReadPipePackets other = (OpGroupReserveReadPipePackets) o;
		...
		if (!this.numPackets.equals(other.numPackets)) {
			return false;
		}
	...
	public int hashCode() {
		...
		result += 31 * result + this.numPackets.hashCode();
