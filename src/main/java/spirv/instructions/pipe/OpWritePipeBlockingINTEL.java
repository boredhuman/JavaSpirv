...
public class OpWritePipeBlockingINTEL implements PipeInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_WRITE_PIPE_BLOCKING_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpWritePipeBlockingINTEL)) {
			return false;
		}
