...
public class OpGetNumPipePackets implements PipeInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GET_NUM_PIPE_PACKETS;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGetNumPipePackets)) {
			return false;
		}
		OpGetNumPipePackets other = (OpGetNumPipePackets) o;
