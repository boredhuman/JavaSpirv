...
public class OpGroupReserveWritePipePackets implements PipeInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_RESERVE_WRITE_PIPE_PACKETS;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupReserveWritePipePackets)) {
			return false;
		}
