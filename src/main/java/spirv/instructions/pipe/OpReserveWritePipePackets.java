...
public class OpReserveWritePipePackets implements PipeInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RESERVE_WRITE_PIPE_PACKETS;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpReserveWritePipePackets)) {
			return false;
		}
