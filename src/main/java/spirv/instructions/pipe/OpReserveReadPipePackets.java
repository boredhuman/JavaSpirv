...
public class OpReserveReadPipePackets implements PipeInstruction, ResultType, Result {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.numPackets = instructions[data[offset + 3]];
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RESERVE_READ_PIPE_PACKETS;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpReserveReadPipePackets)) {
			return false;
		}
		OpReserveReadPipePackets other = (OpReserveReadPipePackets) o;
