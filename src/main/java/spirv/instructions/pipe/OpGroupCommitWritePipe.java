...
public class OpGroupCommitWritePipe implements PipeInstruction {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.pipe = instructions[data[offset + 1]];
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GROUP_COMMIT_WRITE_PIPE;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGroupCommitWritePipe)) {
			return false;
		}
		OpGroupCommitWritePipe other = (OpGroupCommitWritePipe) o;
