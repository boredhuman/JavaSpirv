...
public class OpCooperativeMatrixLengthKHR implements MiscellaneousInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_COOPERATIVE_MATRIX_LENGTH_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpCooperativeMatrixLengthKHR)) {
			return false;
		}
