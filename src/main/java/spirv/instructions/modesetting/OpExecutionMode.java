...
public class OpExecutionMode implements ModeSettingInstruction {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_EXECUTION_MODE;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpExecutionMode)) {
			return false;
		}
		OpExecutionMode other = (OpExecutionMode) o;
