...
public class OpControlBarrierWaitINTEL implements BarrierInstruction {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONTROL_BARRIER_WAIT_INTEL;
	}

	@Override
	public String[] capabilities() {
		 return new String[] { "SplitBarrierINTEL" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpControlBarrierWaitINTEL)) {
			return false;
		}
		OpControlBarrierWaitINTEL other = (OpControlBarrierWaitINTEL) o;
