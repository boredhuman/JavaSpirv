...
public class OpControlBarrierArriveINTEL implements BarrierInstruction {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONTROL_BARRIER_ARRIVE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpControlBarrierArriveINTEL)) {
			return false;
		}
