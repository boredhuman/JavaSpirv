...
public class OpTypeAvcMcePayloadINTEL implements Instruction, Result {
	public int idResult;
	...
	@Override
	public int opcode() {
		return OpCodes.OP_TYPE_AVC_MCE_PAYLOAD_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpTypeAvcMcePayloadINTEL)) {
			return false;
		}
