...
public class OpArbitraryFloatLog1pINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_LOG1P_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatLog1pINTEL)) {
			return false;
		}
		OpArbitraryFloatLog1pINTEL other = (OpArbitraryFloatLog1pINTEL) o;
