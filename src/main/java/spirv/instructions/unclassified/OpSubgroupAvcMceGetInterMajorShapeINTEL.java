...
public class OpSubgroupAvcMceGetInterMajorShapeINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_MCE_GET_INTER_MAJOR_SHAPE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcMceGetInterMajorShapeINTEL)) {
			return false;
		}
