...
public class OpFixedLogINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FIXED_LOG_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFixedLogINTEL)) {
			return false;
		}
		OpFixedLogINTEL other = (OpFixedLogINTEL) o;
