...
public class OpArbitraryFloatCosPiINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_COS_PI_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatCosPiINTEL)) {
			return false;
		}
		OpArbitraryFloatCosPiINTEL other = (OpArbitraryFloatCosPiINTEL) o;
