...
public class OpArbitraryFloatPowINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_POW_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatPowINTEL)) {
			return false;
		}
		OpArbitraryFloatPowINTEL other = (OpArbitraryFloatPowINTEL) o;
