...
public class OpSubgroupAvcImeEvaluateWithSingleReferenceStreaminoutINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_EVALUATE_WITH_SINGLE_REFERENCE_STREAMINOUT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeEvaluateWithSingleReferenceStreaminoutINTEL)) {
			return false;
		}
		OpSubgroupAvcImeEvaluateWithSingleReferenceStreaminoutINTEL other = (OpSubgroupAvcImeEvaluateWithSingleReferenceStreaminoutINTEL) o;
