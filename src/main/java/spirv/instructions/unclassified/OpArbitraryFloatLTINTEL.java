...
public class OpArbitraryFloatLTINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_LTINTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatLTINTEL)) {
			return false;
		}
