...
public class OpArbitraryFloatCastINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_CAST_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatCastINTEL)) {
			return false;
		}
		OpArbitraryFloatCastINTEL other = (OpArbitraryFloatCastINTEL) o;
