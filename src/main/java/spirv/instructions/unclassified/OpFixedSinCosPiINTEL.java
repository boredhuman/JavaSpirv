...
public class OpFixedSinCosPiINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FIXED_SIN_COS_PI_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFixedSinCosPiINTEL)) {
			return false;
		}
		OpFixedSinCosPiINTEL other = (OpFixedSinCosPiINTEL) o;
