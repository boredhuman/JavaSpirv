...
public class OpArbitraryFloatSubINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_SUB_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatSubINTEL)) {
			return false;
		}
		OpArbitraryFloatSubINTEL other = (OpArbitraryFloatSubINTEL) o;
