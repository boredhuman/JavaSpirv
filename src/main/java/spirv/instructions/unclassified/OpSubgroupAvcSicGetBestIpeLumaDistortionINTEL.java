...
public class OpSubgroupAvcSicGetBestIpeLumaDistortionINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_SIC_GET_BEST_IPE_LUMA_DISTORTION_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcSicGetBestIpeLumaDistortionINTEL)) {
			return false;
		}
