...
public class OpConstantFunctionPointerINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONSTANT_FUNCTION_POINTER_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpConstantFunctionPointerINTEL)) {
			return false;
		}
	...
	public int hashCode() {
		...
		return 31 * result + this.function.hashCode();
	}
}