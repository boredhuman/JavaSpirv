...
public class OpSubgroupAvcImeEvaluateWithDualReferenceStreamoutINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_EVALUATE_WITH_DUAL_REFERENCE_STREAMOUT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeEvaluateWithDualReferenceStreamoutINTEL)) {
			return false;
		}
