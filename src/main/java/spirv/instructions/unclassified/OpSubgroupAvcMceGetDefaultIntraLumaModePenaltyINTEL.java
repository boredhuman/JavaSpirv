...
public class OpSubgroupAvcMceGetDefaultIntraLumaModePenaltyINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_MCE_GET_DEFAULT_INTRA_LUMA_MODE_PENALTY_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcMceGetDefaultIntraLumaModePenaltyINTEL)) {
			return false;
		}
		OpSubgroupAvcMceGetDefaultIntraLumaModePenaltyINTEL other = (OpSubgroupAvcMceGetDefaultIntraLumaModePenaltyINTEL) o;
