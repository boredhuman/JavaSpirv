...
public class OpSubgroupAvcRefConvertToMcePayloadINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_REF_CONVERT_TO_MCE_PAYLOAD_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcRefConvertToMcePayloadINTEL)) {
			return false;
		}
