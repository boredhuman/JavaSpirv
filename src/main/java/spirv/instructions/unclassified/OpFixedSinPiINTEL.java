...
public class OpFixedSinPiINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FIXED_SIN_PI_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFixedSinPiINTEL)) {
			return false;
		}
		OpFixedSinPiINTEL other = (OpFixedSinPiINTEL) o;
