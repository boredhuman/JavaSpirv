...
public class OpSubgroupAvcImeGetStreamoutSingleReferenceMajorShapeReferenceIdsINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_GET_STREAMOUT_SINGLE_REFERENCE_MAJOR_SHAPE_REFERENCE_IDS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeGetStreamoutSingleReferenceMajorShapeReferenceIdsINTEL)) {
			return false;
		}
