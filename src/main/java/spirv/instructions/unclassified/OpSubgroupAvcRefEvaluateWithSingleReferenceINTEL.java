...
public class OpSubgroupAvcRefEvaluateWithSingleReferenceINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_REF_EVALUATE_WITH_SINGLE_REFERENCE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcRefEvaluateWithSingleReferenceINTEL)) {
			return false;
		}
		OpSubgroupAvcRefEvaluateWithSingleReferenceINTEL other = (OpSubgroupAvcRefEvaluateWithSingleReferenceINTEL) o;
