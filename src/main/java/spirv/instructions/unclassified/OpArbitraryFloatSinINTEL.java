...
public class OpArbitraryFloatSinINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_SIN_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatSinINTEL)) {
			return false;
		}
		OpArbitraryFloatSinINTEL other = (OpArbitraryFloatSinINTEL) o;
