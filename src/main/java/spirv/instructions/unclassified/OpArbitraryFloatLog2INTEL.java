...
public class OpArbitraryFloatLog2INTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_LOG2INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatLog2INTEL)) {
			return false;
		}
		OpArbitraryFloatLog2INTEL other = (OpArbitraryFloatLog2INTEL) o;
