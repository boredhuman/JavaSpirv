...
public class OpArbitraryFloatSqrtINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_SQRT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatSqrtINTEL)) {
			return false;
		}
		OpArbitraryFloatSqrtINTEL other = (OpArbitraryFloatSqrtINTEL) o;
