...
public class OpSubgroupAvcMceGetDefaultLowPenaltyCostTableINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_MCE_GET_DEFAULT_LOW_PENALTY_COST_TABLE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcMceGetDefaultLowPenaltyCostTableINTEL)) {
			return false;
		}
