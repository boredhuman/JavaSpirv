...
public class OpSubgroupAvcMceSetAcOnlyHaarINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_MCE_SET_AC_ONLY_HAAR_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcMceSetAcOnlyHaarINTEL)) {
			return false;
		}
