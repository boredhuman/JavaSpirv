...
public class OpSubgroupAvcImeGetTruncatedSearchIndicationINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_GET_TRUNCATED_SEARCH_INDICATION_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeGetTruncatedSearchIndicationINTEL)) {
			return false;
		}
