...
public class OpSubgroupAvcSicGetIpeChromaModeINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_SIC_GET_IPE_CHROMA_MODE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcSicGetIpeChromaModeINTEL)) {
			return false;
		}
