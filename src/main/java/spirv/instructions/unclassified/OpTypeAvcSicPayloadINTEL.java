...
public class OpTypeAvcSicPayloadINTEL implements Instruction, Result {
	public int idResult;
	...
	@Override
	public int opcode() {
		return OpCodes.OP_TYPE_AVC_SIC_PAYLOAD_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpTypeAvcSicPayloadINTEL)) {
			return false;
		}
