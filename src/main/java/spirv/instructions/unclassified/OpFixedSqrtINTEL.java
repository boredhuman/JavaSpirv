...
public class OpFixedSqrtINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FIXED_SQRT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFixedSqrtINTEL)) {
			return false;
		}
		OpFixedSqrtINTEL other = (OpFixedSqrtINTEL) o;
