...
public class OpArbitraryFloatCbrtINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_CBRT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatCbrtINTEL)) {
			return false;
		}
		OpArbitraryFloatCbrtINTEL other = (OpArbitraryFloatCbrtINTEL) o;
