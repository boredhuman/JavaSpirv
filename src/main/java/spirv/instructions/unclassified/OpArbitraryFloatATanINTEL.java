...
public class OpArbitraryFloatATanINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_A_TAN_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatATanINTEL)) {
			return false;
		}
		OpArbitraryFloatATanINTEL other = (OpArbitraryFloatATanINTEL) o;
