...
public class OpSubgroupAvcSicGetInterRawSadsINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_SIC_GET_INTER_RAW_SADS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcSicGetInterRawSadsINTEL)) {
			return false;
		}
