...
public class OpArbitraryFloatExp10INTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_EXP10INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatExp10INTEL)) {
			return false;
		}
		OpArbitraryFloatExp10INTEL other = (OpArbitraryFloatExp10INTEL) o;
