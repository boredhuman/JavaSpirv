...
public class OpSubgroupAvcImeConvertToMceResultINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_CONVERT_TO_MCE_RESULT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeConvertToMceResultINTEL)) {
			return false;
		}
