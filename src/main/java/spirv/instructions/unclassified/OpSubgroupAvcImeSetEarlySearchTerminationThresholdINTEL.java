...
public class OpSubgroupAvcImeSetEarlySearchTerminationThresholdINTEL implements Instruction, ResultType, Result {
	public Instruction idResultType;
	public int idResult;
	public Instruction threshold;
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.threshold = instructions[data[offset + 2]];
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_SET_EARLY_SEARCH_TERMINATION_THRESHOLD_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeSetEarlySearchTerminationThresholdINTEL)) {
			return false;
		}
		...
		if (!this.threshold.equals(other.threshold)) {
			return false;
		}
