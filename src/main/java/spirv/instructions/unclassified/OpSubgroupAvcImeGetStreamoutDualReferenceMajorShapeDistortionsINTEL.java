...
public class OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeDistortionsINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_GET_STREAMOUT_DUAL_REFERENCE_MAJOR_SHAPE_DISTORTIONS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeDistortionsINTEL)) {
			return false;
		}
		OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeDistortionsINTEL other = (OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeDistortionsINTEL) o;
