...
public class OpSubgroupAvcRefEvaluateWithDualReferenceINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_REF_EVALUATE_WITH_DUAL_REFERENCE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcRefEvaluateWithDualReferenceINTEL)) {
			return false;
		}
