...
public class OpArbitraryFloatDivINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_DIV_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatDivINTEL)) {
			return false;
		}
		OpArbitraryFloatDivINTEL other = (OpArbitraryFloatDivINTEL) o;
