...
public class OpSubgroupAvcImeGetDualReferenceStreaminINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_GET_DUAL_REFERENCE_STREAMIN_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeGetDualReferenceStreaminINTEL)) {
			return false;
		}
