...
public class OpSubgroupAvcRefSetBilinearFilterEnableINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_REF_SET_BILINEAR_FILTER_ENABLE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcRefSetBilinearFilterEnableINTEL)) {
			return false;
		}
