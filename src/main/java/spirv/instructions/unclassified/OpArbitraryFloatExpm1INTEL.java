...
public class OpArbitraryFloatExpm1INTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_EXPM1INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatExpm1INTEL)) {
			return false;
		}
		OpArbitraryFloatExpm1INTEL other = (OpArbitraryFloatExpm1INTEL) o;
