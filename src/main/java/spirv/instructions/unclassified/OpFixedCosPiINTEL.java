...
public class OpFixedCosPiINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FIXED_COS_PI_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFixedCosPiINTEL)) {
			return false;
		}
		OpFixedCosPiINTEL other = (OpFixedCosPiINTEL) o;
