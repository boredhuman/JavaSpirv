...
public class OpSubgroupAvcMceGetDefaultInterDirectionPenaltyINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_MCE_GET_DEFAULT_INTER_DIRECTION_PENALTY_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcMceGetDefaultInterDirectionPenaltyINTEL)) {
			return false;
		}
