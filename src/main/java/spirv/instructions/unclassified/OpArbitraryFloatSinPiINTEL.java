...
public class OpArbitraryFloatSinPiINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_SIN_PI_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatSinPiINTEL)) {
			return false;
		}
		OpArbitraryFloatSinPiINTEL other = (OpArbitraryFloatSinPiINTEL) o;
