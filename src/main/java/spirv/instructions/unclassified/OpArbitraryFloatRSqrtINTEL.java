...
public class OpArbitraryFloatRSqrtINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_R_SQRT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatRSqrtINTEL)) {
			return false;
		}
		OpArbitraryFloatRSqrtINTEL other = (OpArbitraryFloatRSqrtINTEL) o;
