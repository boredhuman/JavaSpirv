...
public class OpArbitraryFloatRecipINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_RECIP_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatRecipINTEL)) {
			return false;
		}
		OpArbitraryFloatRecipINTEL other = (OpArbitraryFloatRecipINTEL) o;
