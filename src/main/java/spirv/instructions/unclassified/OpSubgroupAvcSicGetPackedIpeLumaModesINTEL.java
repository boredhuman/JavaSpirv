...
public class OpSubgroupAvcSicGetPackedIpeLumaModesINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_SIC_GET_PACKED_IPE_LUMA_MODES_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcSicGetPackedIpeLumaModesINTEL)) {
			return false;
		}
