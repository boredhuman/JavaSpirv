...
public class OpArbitraryFloatEQINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_EQINTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatEQINTEL)) {
			return false;
		}
		OpArbitraryFloatEQINTEL other = (OpArbitraryFloatEQINTEL) o;
