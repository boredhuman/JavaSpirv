...
public class OpArbitraryFloatLogINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_LOG_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatLogINTEL)) {
			return false;
		}
		OpArbitraryFloatLogINTEL other = (OpArbitraryFloatLogINTEL) o;
