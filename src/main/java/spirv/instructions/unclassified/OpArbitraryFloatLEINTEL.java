...
public class OpArbitraryFloatLEINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_LEINTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatLEINTEL)) {
			return false;
		}
		OpArbitraryFloatLEINTEL other = (OpArbitraryFloatLEINTEL) o;
