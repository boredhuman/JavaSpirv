...
public class OpArbitraryFloatPowNINTEL implements Instruction, ResultType, Result {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.signOfB = data[offset + 5];
		this.mresult = data[offset + 6];
		this.subnormal = data[offset + 7];
		this.rounding = data[offset + 8];
		this.accuracy = data[offset + 9];
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_POW_NINTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatPowNINTEL)) {
			return false;
		}
		OpArbitraryFloatPowNINTEL other = (OpArbitraryFloatPowNINTEL) o;
