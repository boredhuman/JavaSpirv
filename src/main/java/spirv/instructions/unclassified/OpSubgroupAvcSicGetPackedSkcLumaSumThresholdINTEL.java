...
public class OpSubgroupAvcSicGetPackedSkcLumaSumThresholdINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_SIC_GET_PACKED_SKC_LUMA_SUM_THRESHOLD_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcSicGetPackedSkcLumaSumThresholdINTEL)) {
			return false;
		}
