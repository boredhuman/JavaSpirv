...
public class OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeMotionVectorsINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_GET_STREAMOUT_DUAL_REFERENCE_MAJOR_SHAPE_MOTION_VECTORS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeGetStreamoutDualReferenceMajorShapeMotionVectorsINTEL)) {
			return false;
		}
