...
public class OpSubgroupAvcMceGetInterReferenceIdsINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_MCE_GET_INTER_REFERENCE_IDS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcMceGetInterReferenceIdsINTEL)) {
			return false;
		}
