...
public class OpArbitraryFloatLog10INTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_LOG10INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatLog10INTEL)) {
			return false;
		}
		OpArbitraryFloatLog10INTEL other = (OpArbitraryFloatLog10INTEL) o;
