...
public class OpSubgroupAvcSicEvaluateWithSingleReferenceINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_SIC_EVALUATE_WITH_SINGLE_REFERENCE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcSicEvaluateWithSingleReferenceINTEL)) {
			return false;
		}
		OpSubgroupAvcSicEvaluateWithSingleReferenceINTEL other = (OpSubgroupAvcSicEvaluateWithSingleReferenceINTEL) o;
