...
public class OpSubgroupAvcMceGetInterDirectionsINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_MCE_GET_INTER_DIRECTIONS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcMceGetInterDirectionsINTEL)) {
			return false;
		}
