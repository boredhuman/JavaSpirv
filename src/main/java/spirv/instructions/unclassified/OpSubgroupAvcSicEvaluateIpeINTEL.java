...
public class OpSubgroupAvcSicEvaluateIpeINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_SIC_EVALUATE_IPE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcSicEvaluateIpeINTEL)) {
			return false;
		}
