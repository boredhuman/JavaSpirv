...
public class OpFixedExpINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FIXED_EXP_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFixedExpINTEL)) {
			return false;
		}
		OpFixedExpINTEL other = (OpFixedExpINTEL) o;
