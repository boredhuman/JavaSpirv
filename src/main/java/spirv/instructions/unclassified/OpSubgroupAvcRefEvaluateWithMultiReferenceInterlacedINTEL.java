...
public class OpSubgroupAvcRefEvaluateWithMultiReferenceInterlacedINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_REF_EVALUATE_WITH_MULTI_REFERENCE_INTERLACED_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcRefEvaluateWithMultiReferenceInterlacedINTEL)) {
			return false;
		}
