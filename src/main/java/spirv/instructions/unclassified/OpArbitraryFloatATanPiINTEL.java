...
public class OpArbitraryFloatATanPiINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_A_TAN_PI_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatATanPiINTEL)) {
			return false;
		}
		OpArbitraryFloatATanPiINTEL other = (OpArbitraryFloatATanPiINTEL) o;
