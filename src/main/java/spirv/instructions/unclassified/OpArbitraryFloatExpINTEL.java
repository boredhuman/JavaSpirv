...
public class OpArbitraryFloatExpINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_EXP_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatExpINTEL)) {
			return false;
		}
		OpArbitraryFloatExpINTEL other = (OpArbitraryFloatExpINTEL) o;
