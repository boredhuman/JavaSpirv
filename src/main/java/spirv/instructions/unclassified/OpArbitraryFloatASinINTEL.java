...
public class OpArbitraryFloatASinINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_A_SIN_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatASinINTEL)) {
			return false;
		}
		OpArbitraryFloatASinINTEL other = (OpArbitraryFloatASinINTEL) o;
