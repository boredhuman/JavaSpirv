...
public class OpArbitraryFloatSinCosINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_SIN_COS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatSinCosINTEL)) {
			return false;
		}
		OpArbitraryFloatSinCosINTEL other = (OpArbitraryFloatSinCosINTEL) o;
