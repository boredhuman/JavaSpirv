...
public class OpFixedSinINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FIXED_SIN_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFixedSinINTEL)) {
			return false;
		}
		OpFixedSinINTEL other = (OpFixedSinINTEL) o;
