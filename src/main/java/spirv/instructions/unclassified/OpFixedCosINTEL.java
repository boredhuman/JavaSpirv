...
public class OpFixedCosINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FIXED_COS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFixedCosINTEL)) {
			return false;
		}
		OpFixedCosINTEL other = (OpFixedCosINTEL) o;
