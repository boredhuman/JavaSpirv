...
public class OpArbitraryFloatCosINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_COS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatCosINTEL)) {
			return false;
		}
		OpArbitraryFloatCosINTEL other = (OpArbitraryFloatCosINTEL) o;
