...
public class OpSubgroupAvcMceGetDefaultInterMotionVectorCostTableINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_MCE_GET_DEFAULT_INTER_MOTION_VECTOR_COST_TABLE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcMceGetDefaultInterMotionVectorCostTableINTEL)) {
			return false;
		}
		OpSubgroupAvcMceGetDefaultInterMotionVectorCostTableINTEL other = (OpSubgroupAvcMceGetDefaultInterMotionVectorCostTableINTEL) o;
