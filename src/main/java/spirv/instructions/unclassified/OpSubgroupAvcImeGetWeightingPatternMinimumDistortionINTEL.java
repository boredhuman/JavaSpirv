...
public class OpSubgroupAvcImeGetWeightingPatternMinimumDistortionINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_IME_GET_WEIGHTING_PATTERN_MINIMUM_DISTORTION_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcImeGetWeightingPatternMinimumDistortionINTEL)) {
			return false;
		}
