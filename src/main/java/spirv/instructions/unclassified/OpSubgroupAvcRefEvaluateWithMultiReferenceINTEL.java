...
public class OpSubgroupAvcRefEvaluateWithMultiReferenceINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_REF_EVALUATE_WITH_MULTI_REFERENCE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcRefEvaluateWithMultiReferenceINTEL)) {
			return false;
		}
		OpSubgroupAvcRefEvaluateWithMultiReferenceINTEL other = (OpSubgroupAvcRefEvaluateWithMultiReferenceINTEL) o;
