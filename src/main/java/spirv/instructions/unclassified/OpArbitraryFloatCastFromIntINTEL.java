...
public class OpArbitraryFloatCastFromIntINTEL implements Instruction, ResultType, Result {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.mresult = data[offset + 3];
		this.fromSign = data[offset + 4];
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_CAST_FROM_INT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatCastFromIntINTEL)) {
			return false;
		}
		OpArbitraryFloatCastFromIntINTEL other = (OpArbitraryFloatCastFromIntINTEL) o;
		...
		if (this.fromSign != other.fromSign) {
			return false;
		}
	...
	public int hashCode() {
		...
		result += 31 * result + this.fromSign;
