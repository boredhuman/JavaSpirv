...
public class OpFixedRecipINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FIXED_RECIP_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFixedRecipINTEL)) {
			return false;
		}
		OpFixedRecipINTEL other = (OpFixedRecipINTEL) o;
