...
public class OpArbitraryFloatGEINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_GEINTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatGEINTEL)) {
			return false;
		}
		OpArbitraryFloatGEINTEL other = (OpArbitraryFloatGEINTEL) o;
