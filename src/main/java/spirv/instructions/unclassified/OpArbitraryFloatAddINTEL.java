...
public class OpArbitraryFloatAddINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_ADD_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatAddINTEL)) {
			return false;
		}
		OpArbitraryFloatAddINTEL other = (OpArbitraryFloatAddINTEL) o;
