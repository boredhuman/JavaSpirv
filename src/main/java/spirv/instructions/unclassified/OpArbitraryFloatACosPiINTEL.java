...
public class OpArbitraryFloatACosPiINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ARBITRARY_FLOAT_A_COS_PI_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpArbitraryFloatACosPiINTEL)) {
			return false;
		}
		OpArbitraryFloatACosPiINTEL other = (OpArbitraryFloatACosPiINTEL) o;
