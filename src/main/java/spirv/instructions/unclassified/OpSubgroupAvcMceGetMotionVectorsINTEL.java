...
public class OpSubgroupAvcMceGetMotionVectorsINTEL implements Instruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SUBGROUP_AVC_MCE_GET_MOTION_VECTORS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSubgroupAvcMceGetMotionVectorsINTEL)) {
			return false;
		}
