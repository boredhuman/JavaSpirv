...
public class OpRayQueryGetIntersectionInstanceCustomIndexKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_INSTANCE_CUSTOM_INDEX_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionInstanceCustomIndexKHR)) {
			return false;
		}
		OpRayQueryGetIntersectionInstanceCustomIndexKHR other = (OpRayQueryGetIntersectionInstanceCustomIndexKHR) o;
