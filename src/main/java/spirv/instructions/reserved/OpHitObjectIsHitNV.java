...
public class OpHitObjectIsHitNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_IS_HIT_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectIsHitNV)) {
			return false;
		}
		OpHitObjectIsHitNV other = (OpHitObjectIsHitNV) o;
