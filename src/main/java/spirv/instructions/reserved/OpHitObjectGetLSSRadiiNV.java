...
public class OpHitObjectGetLSSRadiiNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_LSS_RADII_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetLSSRadiiNV)) {
			return false;
		}
