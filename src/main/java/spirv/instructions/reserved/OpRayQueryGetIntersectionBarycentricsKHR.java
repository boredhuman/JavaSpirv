...
public class OpRayQueryGetIntersectionBarycentricsKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_BARYCENTRICS_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionBarycentricsKHR)) {
			return false;
		}
