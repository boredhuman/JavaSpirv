...
public class OpRayQueryGetIntersectionLSSHitValueNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_LSS_HIT_VALUE_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionLSSHitValueNV)) {
			return false;
		}
