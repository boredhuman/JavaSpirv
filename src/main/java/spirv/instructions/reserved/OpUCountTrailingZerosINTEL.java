...
public class OpUCountTrailingZerosINTEL implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_U_COUNT_TRAILING_ZEROS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUCountTrailingZerosINTEL)) {
			return false;
		}
		OpUCountTrailingZerosINTEL other = (OpUCountTrailingZerosINTEL) o;
