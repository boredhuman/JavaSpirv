...
public class OpIAddSatINTEL implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_I_ADD_SAT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpIAddSatINTEL)) {
			return false;
		}
		OpIAddSatINTEL other = (OpIAddSatINTEL) o;
