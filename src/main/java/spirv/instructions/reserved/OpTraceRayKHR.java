...
public class OpTraceRayKHR implements ReservedInstruction {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.payload = instructions[data[offset + 10]];
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_TRACE_RAY_KHR;
	}
