...
public class OpHitObjectIsMissNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_IS_MISS_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectIsMissNV)) {
			return false;
		}
		OpHitObjectIsMissNV other = (OpHitObjectIsMissNV) o;
