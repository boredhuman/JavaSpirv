...
public class OpRayQueryGetIntersectionObjectRayOriginKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_OBJECT_RAY_ORIGIN_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionObjectRayOriginKHR)) {
			return false;
		}
