...
public class OpRayQueryGetIntersectionInstanceIdKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_INSTANCE_ID_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionInstanceIdKHR)) {
			return false;
		}
		OpRayQueryGetIntersectionInstanceIdKHR other = (OpRayQueryGetIntersectionInstanceIdKHR) o;
