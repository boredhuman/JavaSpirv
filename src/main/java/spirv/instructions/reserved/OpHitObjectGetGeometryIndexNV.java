...
public class OpHitObjectGetGeometryIndexNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_GEOMETRY_INDEX_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetGeometryIndexNV)) {
			return false;
		}
		OpHitObjectGetGeometryIndexNV other = (OpHitObjectGetGeometryIndexNV) o;
