...
public class OpRayQueryGetClusterIdNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_CLUSTER_ID_NV;
	}
	...
	public String[] capabilities() {
		 return new String[] { "RayTracingClusterAccelerationStructureNV" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetClusterIdNV)) {
			return false;
		}
		OpRayQueryGetClusterIdNV other = (OpRayQueryGetClusterIdNV) o;
