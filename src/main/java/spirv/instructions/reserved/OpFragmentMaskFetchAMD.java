...
public class OpFragmentMaskFetchAMD implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FRAGMENT_MASK_FETCH_AMD;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFragmentMaskFetchAMD)) {
			return false;
		}
