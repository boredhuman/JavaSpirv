...
public class OpHitObjectGetCurrentTimeNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_CURRENT_TIME_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetCurrentTimeNV)) {
			return false;
		}
