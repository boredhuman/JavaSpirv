...
public class OpConvertUToSampledImageNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONVERT_U_TO_SAMPLED_IMAGE_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpConvertUToSampledImageNV)) {
			return false;
		}
		OpConvertUToSampledImageNV other = (OpConvertUToSampledImageNV) o;
