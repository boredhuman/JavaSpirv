...
public class OpCooperativeMatrixLengthNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_COOPERATIVE_MATRIX_LENGTH_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpCooperativeMatrixLengthNV)) {
			return false;
		}
