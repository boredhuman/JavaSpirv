...
public class OpConvertSamplerToUNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONVERT_SAMPLER_TO_UNV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpConvertSamplerToUNV)) {
			return false;
		}
		OpConvertSamplerToUNV other = (OpConvertSamplerToUNV) o;
