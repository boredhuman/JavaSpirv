...
public class OpHitObjectGetRayTMaxNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_RAY_T_MAX_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetRayTMaxNV)) {
			return false;
		}
		OpHitObjectGetRayTMaxNV other = (OpHitObjectGetRayTMaxNV) o;
