...
public class OpHitObjectGetSphereRadiusNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_SPHERE_RADIUS_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetSphereRadiusNV)) {
			return false;
		}
