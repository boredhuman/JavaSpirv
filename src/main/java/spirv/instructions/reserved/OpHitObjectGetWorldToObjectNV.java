...
public class OpHitObjectGetWorldToObjectNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_WORLD_TO_OBJECT_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetWorldToObjectNV)) {
			return false;
		}
		OpHitObjectGetWorldToObjectNV other = (OpHitObjectGetWorldToObjectNV) o;
