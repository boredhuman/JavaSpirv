...
public class OpRayQueryGetIntersectionInstanceShaderBindingTableRecordOffsetKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_INSTANCE_SHADER_BINDING_TABLE_RECORD_OFFSET_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionInstanceShaderBindingTableRecordOffsetKHR)) {
			return false;
		}
