...
public class OpAbsISubINTEL implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_ABS_I_SUB_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpAbsISubINTEL)) {
			return false;
		}
		OpAbsISubINTEL other = (OpAbsISubINTEL) o;
