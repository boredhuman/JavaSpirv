...
public class OpRayQueryGetIntersectionTKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_TKHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionTKHR)) {
			return false;
		}
		OpRayQueryGetIntersectionTKHR other = (OpRayQueryGetIntersectionTKHR) o;
