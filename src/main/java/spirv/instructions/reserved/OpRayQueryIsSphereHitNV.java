...
public class OpRayQueryIsSphereHitNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_IS_SPHERE_HIT_NV;
	}
	...
	public String[] capabilities() {
		 return new String[] { "RayTracingSpheresGeometryNV" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryIsSphereHitNV)) {
			return false;
		}
		OpRayQueryIsSphereHitNV other = (OpRayQueryIsSphereHitNV) o;
