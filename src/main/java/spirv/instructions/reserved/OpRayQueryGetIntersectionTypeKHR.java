...
public class OpRayQueryGetIntersectionTypeKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_TYPE_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionTypeKHR)) {
			return false;
		}
		OpRayQueryGetIntersectionTypeKHR other = (OpRayQueryGetIntersectionTypeKHR) o;
