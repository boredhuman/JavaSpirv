...
public class OpHitObjectGetObjectToWorldNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_OBJECT_TO_WORLD_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetObjectToWorldNV)) {
			return false;
		}
