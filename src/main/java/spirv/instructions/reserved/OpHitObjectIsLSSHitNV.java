...
public class OpHitObjectIsLSSHitNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_IS_LSS_HIT_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectIsLSSHitNV)) {
			return false;
		}
		OpHitObjectIsLSSHitNV other = (OpHitObjectIsLSSHitNV) o;
