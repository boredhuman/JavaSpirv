...
public class OpHitObjectGetWorldRayDirectionNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_WORLD_RAY_DIRECTION_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetWorldRayDirectionNV)) {
			return false;
		}
