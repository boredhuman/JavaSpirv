...
public class OpTensorViewSetDimensionNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_TENSOR_VIEW_SET_DIMENSION_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpTensorViewSetDimensionNV)) {
			return false;
		}
