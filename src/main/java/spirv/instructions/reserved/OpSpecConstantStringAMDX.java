...
public class OpSpecConstantStringAMDX implements ReservedInstruction, Result {
	public int idResult;
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SPEC_CONSTANT_STRING_AMDX;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSpecConstantStringAMDX)) {
			return false;
		}
