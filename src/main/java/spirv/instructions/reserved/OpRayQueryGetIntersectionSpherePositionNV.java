...
public class OpRayQueryGetIntersectionSpherePositionNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_SPHERE_POSITION_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionSpherePositionNV)) {
			return false;
		}
