...
public class OpIAverageRoundedINTEL implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_I_AVERAGE_ROUNDED_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpIAverageRoundedINTEL)) {
			return false;
		}
		OpIAverageRoundedINTEL other = (OpIAverageRoundedINTEL) o;
