...
public class OpHitObjectGetSpherePositionNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_SPHERE_POSITION_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetSpherePositionNV)) {
			return false;
		}
