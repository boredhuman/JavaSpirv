...
public class OpRayQueryGetIntersectionTriangleVertexPositionsKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_TRIANGLE_VERTEX_POSITIONS_KHR;
	}
	...
	public String[] capabilities() {
		 return new String[] { "RayQueryPositionFetchKHR" };
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionTriangleVertexPositionsKHR)) {
			return false;
		}
