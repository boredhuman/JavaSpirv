...
public class OpUAverageINTEL implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_U_AVERAGE_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUAverageINTEL)) {
			return false;
		}
		OpUAverageINTEL other = (OpUAverageINTEL) o;
