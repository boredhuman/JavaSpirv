...
public class OpFetchMicroTriangleVertexBarycentricNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FETCH_MICRO_TRIANGLE_VERTEX_BARYCENTRIC_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFetchMicroTriangleVertexBarycentricNV)) {
			return false;
		}
