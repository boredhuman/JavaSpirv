...
public class OpISubSatINTEL implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_I_SUB_SAT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpISubSatINTEL)) {
			return false;
		}
		OpISubSatINTEL other = (OpISubSatINTEL) o;
