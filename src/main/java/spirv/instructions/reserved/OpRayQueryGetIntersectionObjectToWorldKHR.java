...
public class OpRayQueryGetIntersectionObjectToWorldKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_OBJECT_TO_WORLD_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionObjectToWorldKHR)) {
			return false;
		}
