...
public class OpCooperativeMatrixLoadNV implements ReservedInstruction, ResultType, Result {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.columnMajor = instructions[data[offset + 4]];
		if (length - 5 <= 0) {
			return;
		}
		this.memoryAccess = data[offset + 5];
		this.memoryAccessArg = MemoryAccess.loadArg(this.memoryAccess, data, offset + 6, instructions);
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_COOPERATIVE_MATRIX_LOAD_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpCooperativeMatrixLoadNV)) {
			return false;
		}
