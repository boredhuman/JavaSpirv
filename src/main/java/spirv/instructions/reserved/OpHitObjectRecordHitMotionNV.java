...
public class OpHitObjectRecordHitMotionNV implements ReservedInstruction {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.currentTime = instructions[data[offset + 12]];
		this.hitObjectAttributes = instructions[data[offset + 13]];
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_RECORD_HIT_MOTION_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectRecordHitMotionNV)) {
			return false;
		}
