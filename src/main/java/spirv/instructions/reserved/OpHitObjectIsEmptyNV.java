...
public class OpHitObjectIsEmptyNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_IS_EMPTY_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectIsEmptyNV)) {
			return false;
		}
