...
public class OpHitObjectTraceRayMotionNV implements ReservedInstruction {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.time = instructions[data[offset + 11]];
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_TRACE_RAY_MOTION_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectTraceRayMotionNV)) {
			return false;
		}
