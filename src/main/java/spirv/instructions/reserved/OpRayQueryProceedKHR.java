...
public class OpRayQueryProceedKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_PROCEED_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryProceedKHR)) {
			return false;
		}
