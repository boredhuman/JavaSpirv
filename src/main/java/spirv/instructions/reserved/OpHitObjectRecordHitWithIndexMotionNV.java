...
public class OpHitObjectRecordHitWithIndexMotionNV implements ReservedInstruction {
	...
	public Instruction sbtRecordIndex;
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.sbtRecordIndex = instructions[data[offset + 6]];
		...
		this.currentTime = instructions[data[offset + 11]];
	...
	public void write(InstructionWriter writer) {
		...
		writer.write(this.sbtRecordIndex);
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_RECORD_HIT_WITH_INDEX_MOTION_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectRecordHitWithIndexMotionNV)) {
			return false;
		}
		OpHitObjectRecordHitWithIndexMotionNV other = (OpHitObjectRecordHitWithIndexMotionNV) o;
		...
		if (!this.sbtRecordIndex.equals(other.sbtRecordIndex)) {
			return false;
		}
