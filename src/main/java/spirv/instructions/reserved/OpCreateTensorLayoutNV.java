...
public class OpCreateTensorLayoutNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CREATE_TENSOR_LAYOUT_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpCreateTensorLayoutNV)) {
			return false;
		}
