...
public class OpConvertUToImageNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONVERT_U_TO_IMAGE_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpConvertUToImageNV)) {
			return false;
		}
		OpConvertUToImageNV other = (OpConvertUToImageNV) o;
