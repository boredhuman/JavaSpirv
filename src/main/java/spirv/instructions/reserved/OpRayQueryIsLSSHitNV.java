...
public class OpRayQueryIsLSSHitNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_IS_LSS_HIT_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryIsLSSHitNV)) {
			return false;
		}
