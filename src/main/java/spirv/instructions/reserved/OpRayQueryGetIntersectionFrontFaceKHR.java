...
public class OpRayQueryGetIntersectionFrontFaceKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_FRONT_FACE_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionFrontFaceKHR)) {
			return false;
		}
		OpRayQueryGetIntersectionFrontFaceKHR other = (OpRayQueryGetIntersectionFrontFaceKHR) o;
