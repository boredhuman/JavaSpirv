...
public class OpIMul32x16INTEL implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_I_MUL32X16INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpIMul32x16INTEL)) {
			return false;
		}
		OpIMul32x16INTEL other = (OpIMul32x16INTEL) o;
