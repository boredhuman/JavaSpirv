...
public class OpHitObjectGetClusterIdNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_CLUSTER_ID_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetClusterIdNV)) {
			return false;
		}
