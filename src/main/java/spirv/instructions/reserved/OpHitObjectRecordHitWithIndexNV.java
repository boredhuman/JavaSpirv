...
public class OpHitObjectRecordHitWithIndexNV implements ReservedInstruction {
	...
	public void load(int[] data, int offset, int length, Instruction[] instructions) {
		...
		this.hitObjectAttributes = instructions[data[offset + 11]];
	}
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_RECORD_HIT_WITH_INDEX_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectRecordHitWithIndexNV)) {
			return false;
		}
