...
public class OpHitObjectIsSphereHitNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_IS_SPHERE_HIT_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectIsSphereHitNV)) {
			return false;
		}
