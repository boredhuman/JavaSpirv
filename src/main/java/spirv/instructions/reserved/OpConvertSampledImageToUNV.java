...
public class OpConvertSampledImageToUNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONVERT_SAMPLED_IMAGE_TO_UNV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpConvertSampledImageToUNV)) {
			return false;
		}
		OpConvertSampledImageToUNV other = (OpConvertSampledImageToUNV) o;
