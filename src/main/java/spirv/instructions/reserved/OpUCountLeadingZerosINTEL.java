...
public class OpUCountLeadingZerosINTEL implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_U_COUNT_LEADING_ZEROS_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUCountLeadingZerosINTEL)) {
			return false;
		}
		OpUCountLeadingZerosINTEL other = (OpUCountLeadingZerosINTEL) o;
