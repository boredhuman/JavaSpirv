...
public class OpUSubSatINTEL implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_U_SUB_SAT_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpUSubSatINTEL)) {
			return false;
		}
		OpUSubSatINTEL other = (OpUSubSatINTEL) o;
