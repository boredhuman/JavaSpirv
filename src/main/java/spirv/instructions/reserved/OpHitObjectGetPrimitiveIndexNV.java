...
public class OpHitObjectGetPrimitiveIndexNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_PRIMITIVE_INDEX_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetPrimitiveIndexNV)) {
			return false;
		}
		OpHitObjectGetPrimitiveIndexNV other = (OpHitObjectGetPrimitiveIndexNV) o;
