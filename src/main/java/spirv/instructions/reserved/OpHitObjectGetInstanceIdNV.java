...
public class OpHitObjectGetInstanceIdNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_INSTANCE_ID_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetInstanceIdNV)) {
			return false;
		}
