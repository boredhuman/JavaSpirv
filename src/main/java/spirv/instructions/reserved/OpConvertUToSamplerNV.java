...
public class OpConvertUToSamplerNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONVERT_U_TO_SAMPLER_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpConvertUToSamplerNV)) {
			return false;
		}
