...
public class OpRayQueryGetRayTMinKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_RAY_T_MIN_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetRayTMinKHR)) {
			return false;
		}
		OpRayQueryGetRayTMinKHR other = (OpRayQueryGetRayTMinKHR) o;
