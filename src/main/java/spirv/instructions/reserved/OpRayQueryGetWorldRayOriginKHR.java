...
public class OpRayQueryGetWorldRayOriginKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_WORLD_RAY_ORIGIN_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetWorldRayOriginKHR)) {
			return false;
		}
