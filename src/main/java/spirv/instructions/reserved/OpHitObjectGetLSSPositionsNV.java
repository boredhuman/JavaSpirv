...
public class OpHitObjectGetLSSPositionsNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_LSS_POSITIONS_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetLSSPositionsNV)) {
			return false;
		}
