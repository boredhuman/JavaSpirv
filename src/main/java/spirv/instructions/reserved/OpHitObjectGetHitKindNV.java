...
public class OpHitObjectGetHitKindNV implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_HIT_OBJECT_GET_HIT_KIND_NV;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpHitObjectGetHitKindNV)) {
			return false;
		}
		OpHitObjectGetHitKindNV other = (OpHitObjectGetHitKindNV) o;
