...
public class OpFinishWritingNodePayloadAMDX implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_FINISH_WRITING_NODE_PAYLOAD_AMDX;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpFinishWritingNodePayloadAMDX)) {
			return false;
		}
