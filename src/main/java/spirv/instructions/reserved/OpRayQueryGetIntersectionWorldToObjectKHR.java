...
public class OpRayQueryGetIntersectionWorldToObjectKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_WORLD_TO_OBJECT_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionWorldToObjectKHR)) {
			return false;
		}
		OpRayQueryGetIntersectionWorldToObjectKHR other = (OpRayQueryGetIntersectionWorldToObjectKHR) o;
