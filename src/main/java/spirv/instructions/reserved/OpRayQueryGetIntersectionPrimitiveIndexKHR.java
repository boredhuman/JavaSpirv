...
public class OpRayQueryGetIntersectionPrimitiveIndexKHR implements ReservedInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_RAY_QUERY_GET_INTERSECTION_PRIMITIVE_INDEX_KHR;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpRayQueryGetIntersectionPrimitiveIndexKHR)) {
			return false;
		}
