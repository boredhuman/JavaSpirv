...
public class OpGetKernelWorkGroupSize implements DeviceSideEnqueueInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GET_KERNEL_WORK_GROUP_SIZE;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGetKernelWorkGroupSize)) {
			return false;
		}
