...
public class OpGetKernelMaxNumSubgroups implements DeviceSideEnqueueInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GET_KERNEL_MAX_NUM_SUBGROUPS;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGetKernelMaxNumSubgroups)) {
			return false;
		}
