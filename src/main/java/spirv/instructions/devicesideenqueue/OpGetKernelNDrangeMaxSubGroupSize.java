...
public class OpGetKernelNDrangeMaxSubGroupSize implements DeviceSideEnqueueInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_GET_KERNEL_N_DRANGE_MAX_SUB_GROUP_SIZE;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpGetKernelNDrangeMaxSubGroupSize)) {
			return false;
		}
