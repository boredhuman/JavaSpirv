...
public class OpCompositeConstruct implements CompositeInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_COMPOSITE_CONSTRUCT;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpCompositeConstruct)) {
			return false;
		}
