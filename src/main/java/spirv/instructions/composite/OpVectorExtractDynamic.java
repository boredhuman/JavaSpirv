...
public class OpVectorExtractDynamic implements CompositeInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_VECTOR_EXTRACT_DYNAMIC;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpVectorExtractDynamic)) {
			return false;
		}
