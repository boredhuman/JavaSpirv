...
public class OpCompositeConstructContinuedINTEL implements CompositeInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_COMPOSITE_CONSTRUCT_CONTINUED_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpCompositeConstructContinuedINTEL)) {
			return false;
		}
