...
public class OpConstantComposite implements ConstantCreationInstruction, ResultType, Result {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_CONSTANT_COMPOSITE;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpConstantComposite)) {
			return false;
		}
