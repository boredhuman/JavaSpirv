...
public class OpSpecConstantCompositeContinuedINTEL implements ConstantCreationInstruction {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_SPEC_CONSTANT_COMPOSITE_CONTINUED_INTEL;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpSpecConstantCompositeContinuedINTEL)) {
			return false;
		}
		OpSpecConstantCompositeContinuedINTEL other = (OpSpecConstantCompositeContinuedINTEL) o;
