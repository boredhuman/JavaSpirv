...
public class OpLifetimeStop implements ControlFlowInstruction {
	...
	@Override
	public int opcode() {
		return OpCodes.OP_LIFETIME_STOP;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof OpLifetimeStop)) {
			return false;
		}
		OpLifetimeStop other = (OpLifetimeStop) o;
